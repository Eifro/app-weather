  ...
  return (
    <div className="about text-white">
      ...
      <div className="container mx-auto text-center mt-12">
        ...
        <div className="description w-4/5 mx-auto flex flex-col gap-2 text-lg mb-12">
          <p>
          ...
          <p className="font-bold tracking-wider text-2xl text-shadow-xl mt-10">Made with Miguel Espiritu <FontAwesomeIcon icon={faMugHot} className="text-yellow-500" /></p>
        </div>
        <Link to='/' className="btn-back-home border-2 px-3 py-2 rounded text-lg font-bold uppercase tracking-wide hover:bg-white hover:text-zinc-600 transition duration-600">Back <FontAwesomeIcon icon={faArrowTurnDown} className="rotate-90" /> </Link>
      </div>
    </div>
  );
}
