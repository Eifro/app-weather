  ...
  return (
    <div className="search-bar bg-sky-600 py-5">
      <form onSubmit={handleSubmit} className="container mx-auto flex gap-5 w-max md:w-full">
        <input type="text" value={input} className="input-search border-2 border-white rounded focus:outline-none px-3 py-1 text-zinc-700 text-lg hover:bg-neutral-200 focus:bg-neutral-200 w-48" placeholder='Buscar país..' onChange={handleChange} />
